Schedule I 简体中文离线汉化 1.3.10
适配版本：Schedule I v0.4.5f2 / Steam Build 22829923

【安装方式一：一键 EXE（推荐）】
1. 完全退出游戏。
2. 运行 ScheduleIChineseInstaller-v1.3.10.exe。
...
【翻译与验证】
- 主翻译表：10,884 个唯一键，校验错误 0。
- 显示层精修/补漏：218 个唯一键，校验错误 0。
- 效果与形容词：51 个唯一词条，校验错误 0。
- 动态格式规则：331 条，错误 0，警告 0。
- 人名与自定义名称保护映射：5,075 条。
- 离线关键用例自检：31/31 通过。
